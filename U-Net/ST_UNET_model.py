...
# bottleneck
        ...
        self.up1 = (Up(64,64+48,48))
        
        self.up2 = (Up(48, 48+32, 32))
        # self.residual5 = (ResidualBlock(48,32))

        self.up3 = (Up(32, 32+4, 4))
        self.residual4 = (ResidualBlock(4,4))
...
#trans
        ...
        # out4 = self.residual4(out4)

        out5 = self.up2(out4, out1)
        # out5 = self.residual5(out5)

        out6 = self.up3(out5, out0)
        # out6 = self.residual6(out6) 

        out7 = self.residual4(out6)
